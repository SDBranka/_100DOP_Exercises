...
# Ex1
# You are painting a wall. The instructions on the paint can says that 1 can 
...
# 2. Make sure you name your function/parameters the same as when it's called on the
# last line of code.
...
# into it is a prime number or not.
